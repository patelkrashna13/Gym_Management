  ...
  return (
          <div className="w-full">
            <div className="w-full mb-5 h-40 mt-[-4rem]">
                ...
                <input type="text" className='w-1/2 p-2 mt-[1rem] ml-[0.5rem] rounded-lg border-2 border-slate-400' placeholder='Enter Email'/>
            </div>

            {
                emailSubmit && <div className="w-full mb-5 mt-[-5rem]">
                <div className="ml-[0.5rem] text-shadow-sm">Enter Your OTP</div>
                <input type="text" className='w-1/2 p-2 mt-[1rem] ml-[0.5rem] rounded-lg border-2 border-slate-400' placeholder='Enter OTP'/>
            </div> 
            }
            
            {
                ...
                <input type="text" className='w-1/2 p-2 mt-[1rem] ml-[0.5rem] rounded-lg border-2 border-slate-400' placeholder='Enter New Password'/>
            </div> 
            }
